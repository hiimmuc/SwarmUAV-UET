...
from App_controlCamera.control import Ui_SETTING
...
# ---------------------------------------------------------------------------------------
    ...
    def Record(self):
        ...
        if (cam.getRecordingState() == cam._record_msg.ON):
            ...
            self.uic.plainTextEdit.appendPlainText(
                "Recording is ON. Sending requesdt to stop recording")
            cam.requestRecording()
            sleep(2)
...
class capture_video(QThread):
    ...
    def run(self):
        # '/home/lamvu/Downloads/140111-774507949_tiny.mp4''rtsp://192.168.144.25:8554/main.264'
