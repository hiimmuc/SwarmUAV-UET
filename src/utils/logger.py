...
class Logger:
    ...
    def __init__(
        ...
        # Create formatter
        self.formatter = logging.Formatter(fmt=log_format, style="{", datefmt=date_format)
    ...
    def log(self, message: str, level: str = "info", exc_info: bool = None) -> None:
        """
...
def get_logger(name: str = "UAV-logger", **kwargs: Any) -> Logger:
    """
...
if __name__ == "__main__":
    # Example usage
    logger = get_logger(log_dir="logs", console_level="debug")
