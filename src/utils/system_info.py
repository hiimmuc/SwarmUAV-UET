...
def get_memory_info() -> Dict[str, Dict[str, Any]]:
    ...
    return {"ram": ram_info, "swap": swap_info}
...
def get_disk_info() -> Dict[str, Any]:
    ...
    for partition in psutil.disk_partitions():
        ...
        try:
            ...
            partition_info.update({"error": "Access denied or not mounted"})
    ...
    return {"partitions": partitions_info, "io_stats": io_info}
...
def get_network_info() -> Dict[str, Any]:
    ...
    for interface_name, addresses in psutil.net_if_addrs().items():
        interfaces[interface_name] = {"ipv4": [], "ipv6": [], "mac": []}
    ...
    return {"interfaces": interfaces, "io_stats": io_stats, "per_interface_stats": per_nic_stats}
