...
def main():
    ...
    Drone_image = ImageTk.PhotoImage(
        Image.open(f"{parent_dir}/map/images/Drone.png").resize((20, 20))
    )
    dot_image = ImageTk.PhotoImage(Image.open(f"{parent_dir}/map/images/Dot.png").resize((10, 10)))
