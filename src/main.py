...
from PyQt5.QtWidgets import QMainWindow, QApplication, QGraphicsDropShadowEffect, QSizeGrip, QFileDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):  # Định nghĩa phương thức __init__
        ...
        with open(f'{parent_dir}/data/ID_drone.txt', "r") as file:  # Đọc nội dung của file
        ...
        self.ui.land_drone_2.clicked.connect(
            lambda: asyncio.create_task(self.Land_2()))
        self.ui.land_drone_3.clicked.connect(
            lambda: asyncio.create_task(self.Land_3()))
        self.ui.land_drone_4.clicked.connect(
            lambda: asyncio.create_task(self.Land_4()))
        self.ui.land_drone_5.clicked.connect(
            lambda: asyncio.create_task(self.Land_5()))
        self.ui.land_drone_6.clicked.connect(
            lambda: asyncio.create_task(self.Land_6()))
        ...
        self.ui.goto_2.clicked.connect(
            lambda: asyncio.create_task(self.goto_2()))
        self.ui.goto_3.clicked.connect(
            lambda: asyncio.create_task(self.goto_3()))
        self.ui.goto_4.clicked.connect(
            lambda: asyncio.create_task(self.goto_4()))
        self.ui.goto_5.clicked.connect(
            lambda: asyncio.create_task(self.goto_5()))
        self.ui.goto_6.clicked.connect(
            lambda: asyncio.create_task(self.goto_6()))
        ...
        self.ui.pause_2.clicked.connect(
            lambda: asyncio.create_task(self.pause_2()))
        self.ui.pause_3.clicked.connect(
            lambda: asyncio.create_task(self.pause_3()))
        self.ui.pause_4.clicked.connect(
            lambda: asyncio.create_task(self.pause_4()))
        self.ui.pause_5.clicked.connect(
            lambda: asyncio.create_task(self.pause_5()))
        self.ui.pause_6.clicked.connect(
            lambda: asyncio.create_task(self.pause_6()))
        ...
        # arm multi drone
        self.ui.arm_all.clicked.connect(
            lambda: asyncio.create_task(self.arm_6_drone()))
        ...
        self.ui.RTL_all_2.clicked.connect(
            lambda: asyncio.create_task(self.RTL_ALL()))
        ...
        self.ui.goto_all.clicked.connect(
            lambda: asyncio.create_task(self.goto_all()))

        # Tạm dừng thực hiện nhiệm vụ các drone
        self.ui.pause_all.clicked.connect(
        ...
        self.ui.btn_home.clicked.connect(lambda: self.ui.btn_home.setStyleSheet(
            "background-color: rgb(255, 255, 255);"))  # Đổi màu nút
        self.ui.btn_home.clicked.connect(lambda: self.ui.btn_connect.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_home.clicked.connect(lambda: self.ui.btn_map.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_home.clicked.connect(lambda: self.ui.btn_algorithm.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_home.clicked.connect(lambda: self.ui.btn_parameter.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))

        self.ui.btn_connect.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(
            self.ui.page_connect))  # khi nhấn btn_connect thì gọi đến page_connect
        self.ui.btn_connect.clicked.connect(lambda: self.ui.btn_connect.setStyleSheet(
            "background-color: rgb(255, 255, 255);"))
        self.ui.btn_connect.clicked.connect(lambda: self.ui.btn_home.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_connect.clicked.connect(
            lambda: self.ui.btn_map.setStyleSheet("background-color: rgb(118, 118, 118);"))
        self.ui.btn_connect.clicked.connect(lambda: self.ui.btn_algorithm.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_connect.clicked.connect(lambda: self.ui.btn_parameter.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))

        self.ui.btn_map.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(
            self.ui.page_map))   # Khi nhấn btn_map thì gọi đến page_map
        self.ui.btn_map.clicked.connect(lambda: self.ui.btn_map.setStyleSheet(
            "background-color: rgb(255, 255, 255);"))
        self.ui.btn_map.clicked.connect(lambda: self.ui.btn_home.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_map.clicked.connect(lambda: self.ui.btn_connect.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_map.clicked.connect(lambda: self.ui.btn_algorithm.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_map.clicked.connect(lambda: self.ui.btn_parameter.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        ...
        self.ui.btn_parameter.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(
            self.ui.page_parameter))   # Khi nhấn nút btn_parameter thì gọi đến page_parameter
        self.ui.btn_parameter.clicked.connect(lambda: self.ui.btn_parameter.setStyleSheet(
            "background-color: rgb(255, 255, 255);"))
        self.ui.btn_parameter.clicked.connect(
            lambda: self.ui.btn_home.setStyleSheet("background-color: rgb(118, 118, 118);"))
        self.ui.btn_parameter.clicked.connect(lambda: self.ui.btn_connect.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
        self.ui.btn_parameter.clicked.connect(
            lambda: self.ui.btn_map.setStyleSheet("background-color: rgb(118, 118, 118);"))
        self.ui.btn_parameter.clicked.connect(lambda: self.ui.btn_algorithm.setStyleSheet(
            "background-color: rgb(118, 118, 118);"))
    ...
    def slideLeftMenu(self):
        ...
        # Nếu menu có chiều rộng max
            ...
            newWidth = 0
            self.ui.open_close_side_bar_btn.setIcon(
                QtGui.QIcon(u":/icons/icons/align-justify.svg"))

        # Tạo chuyển động cho quá trình chuyển đổi
        self.animation = QPropertyAnimation(
            self.ui.slide_menu_container, b"maximumWidth")  # Animate minimumWidht
    ...
    async def Connect_1(self):
        ...
        self.ui.drone_status_1.appendPlainText(
            "--Connecting to Drone 1")  # In ra cửa sổ drone_status
        ...
        self.ui.waiting_connect_1.setStyleSheet(
            "color: rgb(0,255,0);")  # đổi màu chữ của label
        ...
        await asyncio.gather(self.get_alt_1(), self.get_arm_1(), self.get_batt_1(), self.get_mode_1(), self.get_gps_1(),
                             ...
                             self.print_status_text_1(), self.information_1())
        return None
    ...
    async def upload_ms_1(self):
        ...
        with open(f'{parent_dir}/logs/points/points1.txt', "r") as file:
            for line in file:
                ...
                mission_item_1 = MissionItem(lat1,
                                             lon1,
                                             hight1,
                                             float('nan'),
                                             False,
...
###############################################################################################################################################
    async def control_camera(self):
        subprocess.Popen(
            ["python3", f"{parent_dir}/App_controlCamera/main.py"])
...
################################################################################################################################################
    ...
    async def compare_distance(self, num_uav):
        ...
        drones = [drone_1, drone_2, drone_3,
                  drone_4, drone_5]  # Add all drones here
...
# Hàm lấy thông tin setup
    async def information_1(self):
        ...
        self.ui.mis_takeoff_alt_change_1.appendPlainText(
            str(takeoff_altitude_1))
    ...
    async def information_2(self):
        ...
        self.ui.mis_takeoff_alt_change_2.appendPlainText(
            str(takeoff_altitude_2))
    ...
    async def information_3(self):
        ...
        self.ui.mis_takeoff_alt_change_3.appendPlainText(
            str(takeoff_altitude_3))
...
# Hàm chỉnh sửa thông tin
    async def change_information_1(self):
        new_speed_takeoff_1 = float(
            self.ui.mpc_tko_speed_change_1.toPlainText())
        ...
        new_com_disarm_land = float(
            self.ui.com_disarm_land_change_1.toPlainText())
    ...
    async def change_information_2(self):
        new_speed_takeoff_2 = float(
            self.ui.mpc_tko_speed_change_2.toPlainText())
    ...
    async def change_information_3(self):
        new_speed_takeoff_3 = float(
            self.ui.mpc_tko_speed_change_3.toPlainText())
    ...
    async def change_information_4(self):
        new_speed_takeoff_4 = float(
            self.ui.mpc_tko_speed_change_4.toPlainText())
    ...
    async def change_information_5(self):
        new_speed_takeoff_5 = float(
            self.ui.mpc_tko_speed_change_5.toPlainText())
    ...
    async def change_information_6(self):
        new_speed_takeoff_6 = float(
            self.ui.mpc_tko_speed_change_6.toPlainText())
